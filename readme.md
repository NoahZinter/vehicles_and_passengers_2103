...
You have been contracted by the National Park Service to create a program that can track revenue for its parks. Specifically, they would like you to implement the following features:
  ...
  1. Each park can list all the vehicles that entered the park
  1. Each park can list all the passengers that entered the park
  1. Each park can calculate revenue generated. Revenue is generated by charging the admission price 1 integer per adult that entered the park.
